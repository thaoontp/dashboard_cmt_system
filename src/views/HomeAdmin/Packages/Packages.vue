	  ...
	  <a-modal
		...
		<form @submit.prevent="handleAddPackage">
			...
			<div class="rightModal col">
				...
				/>
				<span class="error" v-if="errors.NUMBER_OF_PRODUCT">{{ errors.NUMBER_OF_PRODUCT }}</span> 
				</div>
				<div class="groupForm">
				...
				/>
				<span class="error" v-if="errors.NUMBER_OF_COMMENT">{{ errors.NUMBER_OF_COMMENT }}</span>
				</div>
				<div class="groupForm">
				<span>Mô tả:</span>
				<textarea
				...
				/>
				<span class="error" v-if="errors.DISCOUNT">{{ errors.DISCOUNT }}</span> 
				</div>
				<div class="groupForm">
